...
Advanced_station::Advanced_station(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
  ...
  CheckBox1 = new wxCheckBox(this, ID_CHECKBOX1, _("Refresh station parameters"), wxDefaultPosition, wxDefaultSize, 0, wxGenericValidator(&settings.station_extra[0]), _T("ID_CHECKBOX1"));
  CheckBox1->SetValue(false);
  BoxSizer1->Add(CheckBox1, 1, wxLEFT|wxALIGN_LEFT, 5);
  CheckBox2 = new wxCheckBox(this, ID_CHECKBOX2, _("Acquiring new chatmail address"), wxDefaultPosition, wxDefaultSize, 0, wxGenericValidator(&settings.station_extra[1]), _T("ID_CHECKBOX2"));
  CheckBox2->SetValue(false);
  BoxSizer1->Add(CheckBox2, 1, wxLEFT|wxALIGN_LEFT, 5);
  CheckBox3 = new wxCheckBox(this, ID_CHECKBOX3, _("Deleting all chats"), wxDefaultPosition, wxDefaultSize, 0, wxGenericValidator(&settings.station_extra[2]), _T("ID_CHECKBOX3"));
  CheckBox3->SetValue(false);
  BoxSizer1->Add(CheckBox3, 1, wxLEFT|wxALIGN_LEFT, 5);
  CheckBox4 = new wxCheckBox(this, ID_CHECKBOX4, _("Accepts S/C along with $/#"), wxDefaultPosition, wxDefaultSize, 0, wxGenericValidator(&settings.station_extra[3]), _T("ID_CHECKBOX4"));
  CheckBox4->SetValue(false);
  BoxSizer1->Add(CheckBox4, 1, wxLEFT|wxALIGN_LEFT, 5);
  CheckBox5 = new wxCheckBox(this, ID_CHECKBOX5, _("Label"), wxDefaultPosition, wxDefaultSize, 0, wxGenericValidator(&settings.station_extra[4]), _T("ID_CHECKBOX5"));
  CheckBox5->SetValue(false);
  BoxSizer1->Add(CheckBox5, 1, wxLEFT|wxALIGN_LEFT, 5);
  CheckBox6 = new wxCheckBox(this, ID_CHECKBOX6, _("Label"), wxDefaultPosition, wxDefaultSize, 0, wxGenericValidator(&settings.station_extra[5]), _T("ID_CHECKBOX6"));
