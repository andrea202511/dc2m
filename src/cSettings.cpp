...
void C_Settings::LoadValue() {
  ...
  dconfig->Read(wxT("/CH1_alias"),&ch1.name);
	dconfig->Read(wxT("/CH1_run"),&ch1.run);
	...
	dconfig->Read(wxT("/CH1_filemsg"),&ch1.filemsg);
	...
	dconfig->Read(wxT("/CH2_run"),&ch2.run);
	...
	dconfig->Read(wxT("/CH2_filemsg"),&ch2.filemsg);
	...
	dconfig->Read(wxT("/CH3_run"),&ch3.run);
	...
	dconfig->Read(wxT("/CH3_filemsg"),&ch3.filemsg);
...
void C_Settings::SaveValue() {
  ...
  dconfig->Write(wxT("/StationLoc"),station_loc);
	...
	dconfig->Write(wxT("/CH1_run"),ch1.run);
	...
	dconfig->Write(wxT("/CH1_filemsg"),ch1.filemsg);
	...
	dconfig->Write(wxT("/CH2_run"),ch2.run);
	...
	dconfig->Write(wxT("/CH2_filemsg"),ch2.filemsg);
	...
	dconfig->Write(wxT("/CH3_run"),ch3.run);
	...
	dconfig->Write(wxT("/CH3_filemsg"),ch3.filemsg);
